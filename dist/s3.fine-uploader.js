// Fine Uploader 5.14.0-justice - (c) 2013-present Widen Enterprises, Inc. MIT licensed. http://fineuploader.com
(function(global) {
    ...
    (function() {
        ...
        qq.uiPrivateApi = {
            ...
            _markFileAsFailed: function(id, result) {
                var templating = this._templating, fileContainer = templating.getFileContainer(id);
